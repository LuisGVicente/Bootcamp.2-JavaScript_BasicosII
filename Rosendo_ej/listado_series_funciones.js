...
function showProduct(
  ...
  img.setAttribute("alt", imageAltTxt);

  var link = document.createElement("a");
  link.setAttribute("href", productLinkHref);
  var linkTxt = document.createTextNode(productLinkText);

  var year = document.createElement("p");
  var yearTxt = document.createTextNode(productYear);
